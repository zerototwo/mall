...
<form class="form-horizontal" id="update-form" name="update-form" method="post"><div class="form-group"> 
...
<%--Modify product information modal box--%> 
<!-- Modal --> 
<div class="modal fade" id="update-Psw" tabindex="-1" role="dialog" 
...
<div class="col-sm-9"> 
<label style="color: #BD1F3B">Incorrect Password</label> 
</div> 
</div> 
<div class="form-group"> 
...
<label for="name" class="col-sm-2 control-label"></label> 
<div class="col-sm-9"> 
<label style="color: #BD1F3B">Password should be longer than 8</label> 
</div> 
</div> 
...
class="mdl-color-text--blue-grey-400 material-icons" role="presentation">forum</i>Order Management</a> 
...
<td style="border: 0px solid transparent" class="tr" id="userIdVal"> 
${user.getUserid()}</td> 
</tr> 
<tr> 
<th style="border: 0px solid transparent" class="tl">Username</th> 
<td style="border: 0px solid transparent" class="tr" id="nameVal"> 
${user.getUsername()}</td> 
</tr> 
<tr> 
<th style="border: 0px solid transparent" class="tl">Registration 
Time</th> 
...
<td style="border: 0px solid transparent" class="tr" id="emailVal"> 
${user.getEmail()}</td> 
</tr> 
<tr> 
<th style="border: 0px solid transparent" class="tl">Phone Number 
</th> 
<td style="border: 0px solid transparent" class="tr" 
...
<button class="templatemo-blue-button" id="changePsw"> 
...
<%--<script src="https://code.getmdl.io/1.3.0/material.min.js"></script>--%><script src="https://cdn.bootcss.com/material-design-lite/1.3.0/material.min.js"></script> 
</body> 

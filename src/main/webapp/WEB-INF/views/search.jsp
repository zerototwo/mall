    ...
    <%@ page contentType="text/html;charset=UTF-8" language="java" %>
        <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            ...
            <head>
                ...
                <title>School Shop - Search ${keyword}</title>
                ...
                <div id="main" class="container">
                    ...
                    <div class="content">
                        <div class="module">
                            <div class="">
                                <h3>
                                    Search Results><span style="color: red;">${keyword}</span>
                                </h3>
                                <hr>
                            </div>
                            ...
                            <div class="bd">
                                ...
                                <div class="row page-div">
                                    <div class="col-md-5 page-info">
                                        Page ${pageInfo.pageNum} of ${pageInfo.pages}, Total ${pageInfo.size} records
                                    </div>
                                    <div class="col-md-6">

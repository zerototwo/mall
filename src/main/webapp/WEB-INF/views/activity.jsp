                            ...
                            <div class="row">
                                <nav class="templatemo-top-nav col-lg-12 col-md-12">
                                    <ul class="text-uppercase">
                                        <li><a href="${pageContext.request.contextPath}/admin/activity/show"
                                                class="active">All Activities</a></li>
                                        <li><a href="${pageContext.request.contextPath}/admin/activity/add">Add
                                                Activity</a></li>
                                        <%--<li><a
                        ...
                        <div class="templatemo-content-container">
                                    ...
                                    <table id="goodsinfo"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <td><a href="" class="white-text templatemo-sort-by">Activity Name<span
                                                            class="caret"></span></a></td>
                                                <td><a href="" class="white-text templatemo-sort-by">Activity
                                                        Description<span class="caret"></span></a></td>
                                                <td><a href="" class="white-text templatemo-sort-by">Discount<span
                                                            class="caret"></span></a></td>
                                                <td><a href="" class="white-text templatemo-sort-by">Full Reduction<span
                                                            class="caret"></span></a></td>
                                                <td><a href="" class="white-text templatemo-sort-by">Full Free<span
                                                            class="caret"></span></a></td>
                                                <td>Delete</td>
                                            </tr>
                                        </thead>
                                            ...
                                            <c:forEach items="${pageInfo.list}" var="activity" varStatus="num">
                                                <tr>
                                                    ...
                                                    <c:if test="${!empty activity.fullprice}">
                                                        <td>Spend ${activity.fullprice} Save ${activity.reduceprice}
                                                        </td>
                                                    </c:if>
                                                    <c:if test="${empty activity.fullprice}">
                                                        <td>No Full Reduction</td>
                                                    </c:if>

                                                    <c:if test="${!empty activity.fullnum}">
                                                        <td>Buy ${activity.fullnum} Get ${activity.reducenum} Free</td>
                                                    </c:if>
                                                    <c:if test="${empty activity.fullnum}">
                                                        <td>No Full Free</td>
                                                    </c:if>
                                                    <td><a href="${pageContext.request.contextPath}/admin/activity/delete?activityid=${activity.activityid}"
                                                            class="templatemo-delete-btn" style="padding: 0;">Delete</a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                            ...
                            <div class="pagination-wrap" id="page-div-nav">
                                <div class="page-info" id="page-info-area">
                                    Page ${pageInfo.pageNum} of ${pageInfo.pages}, Total ${pageInfo.total} records
                                </div>
                                <ul class="pagination">
                                    <li>

                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content" id="parentModal">
                                ...
                                <div class="modal-body">
                                    <form class="form-inline mt-2 mb-4">
                                        <div data-toggle="distpicker" data-autoselect="3">
                                            <label for="telephone" class="col-sm-2 control-label"
                                                style="padding-left: 28px;padding-top: 10px">Province/City/District</label>
                                    ...
                                    <form class="form-horizontal" id="update-form" name="update-form" method="post">
                                        <div class="form-group">
                                            <label for="detailaddress" class="col-sm-2 control-label">Detailed
                                                Address</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 control-label">Recipient</label>
                                            <div class="col-sm-9">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary" id="saveAddr">Save</button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content" id="parentModalInsert">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="myModalLabelInsert">Add Address</h4>
                                    </div>
                                    <div class="modal-body">
                                        <form class="form-inline mt-2 mb-4">
                                            <div data-toggle="distpicker" data-autoselect="3">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary" id="insertAddr">Save</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
                                <div class="mdl-layout__header-row">
                                    <span class="mdl-layout-title">Shipping Address</span>
                            ...
                            <main class="mdl-layout__content mdl-color--grey-100">
                                        ...
                                        <div
                                            ...
                                            <div class="tab-content">
                                                <table class="table" cellpadding="6" cellspacing="1"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <th style="border: 0px solid transparent" class="tl">
                                                                Recipient</th>
                                                            <td style="border: 0px solid transparent" class="tr"
                                                                id="conname">${item.conname}</td>
                                                        </tr>
                                                        <tr>
                                                            <th style="border: 0px solid transparent" class="tl">Phone
                                                                Number</th>
                                                            <td style="border: 0px solid transparent" class="tr"
                                                                id="contel">${item.contel}</td>
                                                        </tr>
                                                        <tr>
                                                            <th style="border: 0px solid transparent" class="tl">
                                                                Province</th>
                                                        ...
                                                        <tr>
                                                            <th style="border: 0px solid transparent" class="tl">City
                                                            </th>
                                                            <td style="border: 0px solid transparent" class="tr"
                                                                id="city">${item.city}</td>
                                                        </tr>
                                                        <tr>
                                                            <th style="border: 0px solid transparent" class="tl">
                                                                County/District</th>
                                                            <td style="border: 0px solid transparent" class="tr"
                                                                id="county">${item.county}</td>
                                                        </tr>
                                                        <tr>
                                                            <th style="border: 0px solid transparent" class="tl">
                                                                Detailed Address</th>
                                ...
                                <%-- <div class="mdl-grid demo-content">
                                    <div
                                        class="demo-charts mdl-color--white  mdl-shadow--2dp mdl-cell mdl-cell--2-col mdl-grid">
                                        <button class="templatemo-blue-button" name="insertAddr">
                                            <h5>添加地址</h5>
                                        </button>
                                    </div>
